        ...
        >
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 12px 40px rgba(0,0,0,0.3), inset 0 1px 0 rgba(214,178,99,0.15)',
          ...
          >
            ...
            />
            {/* Premium glow effect on image */}
            <div style={{
              position: 'absolute',
              inset: 0,
              borderRadius: 28,
              background: 'linear-gradient(135deg, rgba(214,178,99,0.08), transparent)',
              pointerEvents: 'none'
            }} />
          </motion.div>
          <motion.div
            ...
            >
              {[...Array(4)].map((_, i) => (
                <motion.div
                  key={i}
                  animate={{
                    scale: idx === index && i === index % 4 ? [1, 1.2, 1] : 1,
                  ...
                  style={{
                    ...
                    height: 8,
                    borderRadius: '50%',
                    background: i === index % 4 ? 'var(--gold)' : 'rgba(214,178,99,0.4)',
                    boxShadow: i === index % 4 ? '0 0 12px rgba(214,178,99,0.6)' : 'none'
                  }}
                />
              ))}
            </motion.div>
